...
class LeptopScreen extends StatefulWidget {
  const LeptopScreen({super.key});

  @override
  State<LeptopScreen> createState() => _LeptopScreenState();
}

class _LeptopScreenState extends State<LeptopScreen> {
  var products = [
    {
      "id": 88,
