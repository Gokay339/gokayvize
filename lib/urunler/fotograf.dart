...
class FotografScreen extends StatefulWidget {
  const FotografScreen({super.key});

  @override
  State<FotografScreen> createState() => _FotografScreenState();
}

class _FotografScreenState extends State<FotografScreen> {
  var products = [
    {
      "id": 97,
